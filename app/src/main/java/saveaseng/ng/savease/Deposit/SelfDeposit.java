 ...
 */
public class SelfDeposit extends Fragment {
    ...
    private static final String METHOD_NAME4 = "getBalance";
    private static final String SOAP_ACTION4 = "http://savease.ng/getBalance";
    ...
    private EditText edtVoucher, edtNarrationSelfDeposit;
    private TextView edtAmount;
    Dialog dialog;
    String balance,saveaseId,bvn,transRef;
    private String bank, voucherPin, vouncherSn, accountNumber, accountName, amount, fAmount, username, narration,bvnStatus,bvnFirstName,bvnLastName,bvnPhoneNumber;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_self_deposit, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        edtAmount = (TextView) view.findViewById(R.id.VoucherAmount);
        edtVoucher = (EditText) view.findViewById(R.id.edtVouchPin);
        edtNarrationSelfDeposit = (EditText) view.findViewById(R.id.edtNarrationSelfDeposit);
        ...
        btnDeposit = (Button) view.findViewById(R.id.btnMakeSelfDeposit);
    ...
    private void startDeposit() {
        ...
        narration = edtNarrationSelfDeposit.getText().toString().trim();
        ...
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            new makeSelfDeposit().execute(accountNumber, voucherPin, vouncherSn, bank, accountName, fAmount, username, narration);
    ...
    private class makeSelfDeposit extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            request.addProperty("in_naration", narr);
    ...
    private class getCardAmount extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s == "null") {
                ...
                fAmount = String.valueOf(s);
                edtAmount.setText("Voucher Amount: " + String.valueOf(s));
            }
        }
    ...
    private class getBalance extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.equalsIgnoreCase("")){
                ...
                sendMessage(separated[5]);
                new FancyAlertDialog.Builder(getActivity())
                        .setTitle("Success")
                        .setBackgroundColor(Color.parseColor("#212435"))
                        .setMessage("Your Deposit Transaction was successful")
                        .setPositiveBtnText("Done")
...
//
    ...
    private void sendMessage(String balance) {
        ...
        Call<SmsRes> call = apiInterface.sendMessage(SMS_API_KEY,"Savease","0"+accountNumber, "Your Acct "+newString+ " Has Been Credited with NGN"+ fAmount+ " On "+ formattedDate +" By SAVEASE PREPAID - (Transaction Ref : "+transRef+") Bal: NGN"+balance+"CR, Kindly dial *384*3358# to use our USSD platform","2");
